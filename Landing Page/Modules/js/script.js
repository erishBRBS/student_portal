...
// ==============================================================================
const API_BASE_URL = 'http://dit-rfid.arvin-stg.org/api/v1/';
...
async function handleLogout() {
    ...
    try {
        ...
        console.error('Logout failed on server, forcing client-side cleanup:', error);
        performClientSideLogout();
    }
}
    ...
    loginForm.addEventListener('submit', async (e) => {
        ...
        switch (userType) {
            case 'admin':
                ...
                redirectPath = '../../../Attendance Tracking/modules/Admin/admin-dashboard.html';
                break;
            case 'student':
        ...
        try {
            ...
            if (response.data && response.data.token) {
                ...
                throw new Error('Login failed: Server response is incomplete or missing token.');
            }
            ...
            if (error.response) {
                if (error.response.status === 401 || error.response.status === 404) {
                    ...
                    errorMessage = 'Validation Error: ' + Object.values(error.response.data.errors).flat().join(', ');
                }
            }
