class TeacherSettings {
    ...
    init() {
        ...
        console.log('Teacher Settings initialized!');
    }
    ...
    handleProfilePictureUpload(event) {
        ...
        if (file) {
            ...
            reader.onload = function(e) {
                ...
                localStorage.setItem('teacherProfilePicture', e.target.result);
            };
    ...
    saveProfileSettings() {
        ...
        const teacherNameElements = document.querySelectorAll('.teacher-profile div:last-child, .user-name');
        teacherNameElements.forEach(element => {
            if (element.textContent.includes('Prof.')) {
    ...
    savePreferences() {
        ...
        localStorage.setItem('teacherDesktopNotifications', document.getElementById('desktopNotifications').checked);
    ...
    updateSecuritySettings() {
        ...
        localStorage.setItem('teacherTwoFactorAuth', document.getElementById('twoFactorAuth').checked);
        localStorage.setItem('teacherLoginAlerts', document.getElementById('loginAlerts').checked);
    ...
    loadSavedPreferences() {
        // Load profile data
        const savedFullName = localStorage.getItem('teacherFullName');
        const savedEmail = localStorage.getItem('teacherEmail');
        const savedMobile = localStorage.getItem('teacherMobile');
        const savedDepartment = localStorage.getItem('teacherDepartment');
        const savedProfilePic = localStorage.getItem('teacherProfilePicture');
        ...
        const desktopNotifications = localStorage.getItem('teacherDesktopNotifications');
        const twoFactorAuth = localStorage.getItem('teacherTwoFactorAuth');
        const loginAlerts = localStorage.getItem('teacherLoginAlerts');
