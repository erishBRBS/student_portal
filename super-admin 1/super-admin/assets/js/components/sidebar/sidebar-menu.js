...
export const superAdminMenu = [
  { label: "Dashboard", icon: "fas fa-home", link: "SuperAdmin/super-admin-dashboard" },
  { label: "Attendance Tracking Management", icon: "fas fa-calendar-check", link: "SuperAdmin/attendance-tracking-management" },
  { label: "Grade Portal Management", icon: "fas fa-user-cog", link: "SuperAdmin/grade-portal-management" },
  { label: "Settings", icon: "fas fa-cog", link: "SuperAdmin/super-admin-settings" },
  { label: "Logout", icon: "fas fa-sign-out-alt", link: "SuperAdmin/logout" }
];
...
export const TeacherMenu = [
  { label: "Dashboard", icon: "fas fa-home", link: "Teacher/teacher-dashboard" },
  { label: "Attendance", icon: "fas fa-calendar-check", link: "Teacher/teacher-attendance" },
  { label: "Announcements", icon: "fas fa-user-cog", link: "Teacher/teacher-announcements" },
  { label: "Schedule", icon: "fas fa-clock", link: "Teacher/teacher-schedule" },
  { label: "Students", icon: "fas fa-cog", link: "Teacher/teacher-students" },
